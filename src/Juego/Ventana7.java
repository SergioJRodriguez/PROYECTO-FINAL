...
public class Ventana7 extends JFrame implements MouseListener {
	
	JButton opcionCorrecta = new JButton(new ImageIcon("CLOROPpng.png"));
	JButton opcion2 = new JButton(new ImageIcon("CITOESQUELETO.png"));
	...
	private void enunciado() {
		...
		enunciadoparte1.setText("Los cloroplastos son sacos pequeños llenos de clorofila (color verde)");
		...
		panel.setLayout(null);
		enunciadoparte2.setText("que se encarga de absorber y transformar la energía solar en energía química mediante la");
		...
		panel.setLayout(null);
		enunciadoparte3.setText("fotosíntesis. Están presentes en las plantas, las algas y algunos protistas");
