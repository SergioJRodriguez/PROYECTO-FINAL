...
public class Ventana4 extends JFrame implements MouseListener {
	...
	private void enunciado() {
		...
		enunciadoparte1.setText("Las mitocondrias a través de la respiración, transforman y almacenan");
		...
		panel.setLayout(null);
		enunciadoparte2.setText("en la célula, en una molécula llamada ATP (adenosin trifosfato)");
		...
		panel.setLayout(null);
		enunciadoparte3.setText("la energía química de los alimentos.");
