...
public class Ventana6 extends JFrame implements MouseListener {
	...
	private void enunciado() {
		...
		enunciadoparte1.setText("Los lisosomas son los encargados de la basura. Ellos están pegados al aparato de Golgi");
		...
		panel.setLayout(null);
		enunciadoparte2.setText("degradan las partículas de alimentos y destruyen las sustancias extrañas que entren en la célula.");
		...
		panel.setLayout(null);
		enunciadoparte3.setText("También eliminan organelos dañados reciclando los materiales para formar nuevos organelos");
