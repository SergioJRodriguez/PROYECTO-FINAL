...
public class Ventana10 extends JFrame implements MouseListener {
	...
	private void enunciado() {
		...
		enunciadoparte1.setText("El núcleo: El “gran director,” contiene todas las instrucciones para el funcionamiento");
		...
		panel.setLayout(null);
		enunciadoparte2.setText("adecuado y control de todas las actividades de la célula. También almacena la información");
		...
		panel.setLayout(null);
		enunciadoparte3.setText("genética en las cromatinas formadas por ADN (ácido desoxirribonucleico).\"");
