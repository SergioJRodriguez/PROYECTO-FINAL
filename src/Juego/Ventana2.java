...
public class Ventana2 extends JFrame implements MouseListener {
	...
	JButton opcionCorrecta = new JButton(new ImageIcon("RIBO.png"));
	JButton opcion2 = new JButton(new ImageIcon("PCEpng.png"));
	...
	private void componentesventana() {
		...
		opcionCorrecta.setBounds(100, 150, 300, 250 );
		opcionCorrecta.addMouseListener(this);
		panel.add(opcionCorrecta);
		
		opcion2.setBounds(500, 150, 300, 300 );
	...
	private void enunciado() {
		...
		enunciadoparte1.setText("Los ribosomas son estructuras esféricas que comienzan el proceso de fabricar");
		...
		panel.setLayout(null);
		enunciadoparte2.setText("proteínas. Están adheridas al retículo endoplasmático.");
